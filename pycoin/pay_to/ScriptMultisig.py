...
class ScriptMultisig(ScriptType):
    ...
    def addresses_f(self, netcode=None):
        from ..networks import address_prefix_for_netcode, get_default_netcode
        if netcode is None:
    ...
    def info(self, netcode=None):
        return dict(type="multisig n of m", n=len(self.sec_keys), m=self.m, addresses_f=self.addresses_f,
