...
class InvItem(object):
    def __init__(self, item_type: int, data: bytes, dont_check: bool = False) -> None:
        if not dont_check:
    ...
    def __lt__(self, other: InvItem) -> bool:
    ...
    @classmethod
    def parse(cls, f: IO[bytes]) -> InvItem:
        return cls(*parse_struct("L#", f), dont_check=True)  # type: ignore[misc]
