...
class BuildTxTest(unittest.TestCase):
    ...
    def test_signature_hash(self):
        ...
        bitcoin_address_2 = public_pair_to_bitcoin_address(exponent_2 * generator_secp256k1, compressed=compressed)
        exponent = wif_to_secret_exponent("5JMys7YfK72cRVTrbwkq5paxU7vgkMypB55KyXEtN5uSnjV7K8Y")

        public_key_sec = public_pair_to_sec(exponent * generator_secp256k1, compressed=compressed)
    ...
    def test_build_spends(self):
        ...
        bitcoin_address_3 = public_pair_to_bitcoin_address(exponent_3 * generator_secp256k1, compressed=compressed)
