...
P2SH_ADDRESSES = [
    ...
    "3EyPVdtVrtMJ1XwPT9oiBrQysGpRY8LE9K",
    "32JNcZWZqMX72bpzzgFLhkX56WviowgUtS",
    "3MGhCrETosWs7fhHVPAS6g3UQakA7Xz3wb",
    "3DAP9jDzQ76R4B94qa2Q8CgQrbEXvUoghh",
...
class KeyUtilsTest(unittest.TestCase):
    ...
    def test_key_limits(self):
        ...
        for k in -1, 0, order, order + 1:
            self.assertRaises(
                BTC.keys.InvalidSecretExponentError, BTC.keys.private, secret_exponent=k
            )
            self.assertRaises(
                BTC.keys.InvalidSecretExponentError,
                BIP32Node,
                nc,
                cc,
                secret_exponent=k,
