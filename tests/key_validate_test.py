...
class KeyUtilsTest(unittest.TestCase):
    ...
    def test_key_limits(self):
        ...
        self.assertRaises(InvalidKeyGeneratedError, Key, secret_exponent=generator_secp256k1.order())
        self.assertRaises(InvalidKeyGeneratedError, Key, secret_exponent=generator_secp256k1.order() + 1)
        self.assertRaises(InvalidKeyGeneratedError, BIP32Node, nc, cc, secret_exponent=-1)
        self.assertRaises(InvalidKeyGeneratedError, BIP32Node, nc, cc, secret_exponent=0)
        self.assertRaises(InvalidKeyGeneratedError, BIP32Node, nc, cc, secret_exponent=generator_secp256k1.order())
        self.assertRaises(InvalidKeyGeneratedError, BIP32Node, nc, cc, secret_exponent=generator_secp256k1.order() + 1)
