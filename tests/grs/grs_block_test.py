...
class GroestlcoinBlockTestCase(unittest.TestCase):
    ...
    def test_block_txs(self):
        ...
        self.assertEqual(
            str(tx.hash()),
            "7a64cd89b9e0fd6b32be5deb349e460a90e6805278dee2fe301b347623f0806b",
        )
        ...
        self.assertEqual(
            str(tx.hash()),
            "89ff39e83636359bace69725fe19e1d33b16918205eaaf77c37684ac557e5154",
        )
        self.assertEqual(tx.txs_out[0].coin_value, 664294254)
        self.assertEqual(
            GroestlcoinMainnet.address.for_script(tx.txs_out[0].puzzle_script()),
            "Fdi7YYeN7nmnjJPqQDGy8vudgQ26FVjNrk",
        )
        self.assertEqual(tx.txs_out[1].coin_value, 2365109)
        self.assertEqual(
            GroestlcoinMainnet.address.for_script(tx.txs_out[1].puzzle_script()),
