...
class GroestlcoinEncodingTestCase(unittest.TestCase):
    def test_p2pkh(self):
        ...
        do_test(
            h2b("0000000000000000000000000000000000000000"),
    ...
    def test_bip32(self):
        ...
        self.assertEqual(
            parsed.wif(), "Kybw8izYevo5xMh1TK7aUr7jHFCxXS1zv8p3oqFz3o2zFbjGCYKc"
        )
        self.assertEqual(parsed.address(), "FpjSHmYBamwxWSsPtaL2rUz98FSS17VmY2")
        self.assertEqual(
            parsed.wif(is_compressed=False),
            "5JMbvQZXHJAzJyoDnqWasGCwtiHJZivF2ckjn3n5mazYYwQHway",
        )
        self.assertEqual(
            parsed.address(is_compressed=False), "FrH6KqPfsLPHArqCJ8WciGyvnWcRmvAsHC"
        )
