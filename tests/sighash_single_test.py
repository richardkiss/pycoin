...
from pycoin.ui.ui import script_for_p2pkh
...
class SighashSingleTest(unittest.TestCase):
    ...
    def _test_sighash_single(self, netcode):
        ...
        txs_out = [
            TxOut(900000000, script_for_p2pkh(k3.hash160())),
            TxOut(800000000, script_for_p2pkh(k4.hash160())),
            TxOut(800000000, script_for_p2pkh(k5.hash160())),
        ]
